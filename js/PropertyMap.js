...
$(document).ready(function ()
{
    ...
    try
    {
        ...
        {
            'width': $("a.fancyBox_iframe").attr("width"),
            'height': $("a.fancyBox_iframe").attr("height"),
...
b=b.innerWidth()-b.height(99).innerWidth();a.remove();return b});if(f.support.fixedPosition===r){var a=f.support,d=f('<div style="position:fixed;top:20px;"></div>').appendTo("body"),e=20===d[0].offsetTop||15===d[0].offsetTop;d.remove();a.fixedPosition=e}f.extend(b.defaults,{scrollbarWidth:f.scrollbarWidth(),fixed:f.support.fixedPosition,parent:f("body")})})})(window,document,jQuery);﻿var CurrentPage = "home"; //set home select by default
...
function UpdateProjectList(Min, Max, obj)
{
